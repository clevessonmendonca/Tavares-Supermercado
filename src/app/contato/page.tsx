        ...
        <div className="py-16">
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-4">
            <div className="flex h-80 max-w-sm flex-col items-center justify-center gap-2 rounded bg-gray-100 px-4 py-8 pb-12 text-center shadow-lg">
              ...
              <Link
                className="mx-auto rounded-md px-6 py-2 text-center text-lg font-medium text-blue-600 shadow-lg shadow-primary/10 hover:brightness-90 focus:outline-none focus:ring-2 focus:ring-gray-200 "
                href={"tel:"}
              >
                Entrar em Contato
              </Link>
