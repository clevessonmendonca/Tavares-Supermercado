        ...
        <div className="bg-background pt-8 text-black">
          <div className="container mx-auto px-4">
            ...
            <p className="mx-auto mb-8 max-w-screen-lg leading-6">
              O <span className="font-bold">Supermercado Tavares</span> é uma
              empresa local de destaque, situada na cidade do Gama. O Tavares
            ...
            <p className="mx-auto mb-8 max-w-screen-lg leading-6">
              ...
              <span className="font-bold">Supermercado Tavares</span> oferece
            ...
            <p className="mx-auto mb-8 max-w-screen-lg leading-6">
              ...
              , o Supermercado Tavares oferece muitos tipos de produtos. Isso
            ...
            <div className="mx-auto flex flex-col items-center justify-center gap-6 text-white md:flex-row">
              <div className="h-screen max-h-[225px]  w-full max-w-[300px] rounded border-b-2 border-r-2 border-black bg-radial-tavares px-4 py-8 shadow-xl">
